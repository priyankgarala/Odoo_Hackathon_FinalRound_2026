...
export const AuthProvider = ({ children }: { children: ReactNode }) => {
  ...
  return <AuthContext.Provider value={{ user: signedOut ? undefined : session.data, isLoading: signedOut ? false : session.isLoading, login, logout }}>{children}</AuthContext.Provider>;
};
